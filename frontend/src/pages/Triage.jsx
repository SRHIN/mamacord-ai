...
import { Loader2, HeartPulse, FlaskConical, Scan, User } from "lucide-react";
...
export default function Triage() {
  ...
  function validate() {
    const required = ["age", "gestational_age", "systolic_bp", "diastolic_bp", "temperature", "heart_rate", "hb"];
    const errors = {};
  ...
  return (
    <div className="min-h-screen bg-background pb-10">
      ...
      <form onSubmit={handleSubmit} className="max-w-lg mx-auto px-4 mt-6 space-y-6">
        ...
        {/* Section 4: USS Findings (optional) */}
        <section className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4">
          <button
            type="button"
